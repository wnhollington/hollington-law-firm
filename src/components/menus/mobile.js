                        ...
                        <div className="-my-6 divide-y divide-gray-500/10">
                            ...
                            <div className="my-6 py-6">
                                <div className="flex flex-row justify-center phone">
                                    <a href={`tel:${siteMetaData.contact.phone}`} className="flex gap-2 bg-gradient-to-b from-primary to-red-800 p-3 rounded-lg phone text-lg font-semibold leading-6 text-gray-100 hover:text-gray-200 hover:shadow-lg transition-colors duration-300">
                                        Call Now
                                    </a>
                                </div>
                            </div>
