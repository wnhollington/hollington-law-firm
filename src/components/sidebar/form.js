    ...
    <div className="bg-gradient-to-br from-neutral-100 to-neutral-50 p-4 shadow-xl rounded-md">
        ...
        >
            ...
            <div className="flex items-center justify-center w-full">
                <button type="submit" name="submit" id="submit" className="text-base font-semibold leading-none text-white py-4 px-10 bg-gradient-to-b from-primary to-red-800 hover:bg-primary rounded-md hover:shadow-lg focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:outline-none w-full">SUBMIT</button>
            </div>
