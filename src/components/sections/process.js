...
const Process = () => {
    ...
    const timeline = [
        {id: 0, point: "Legal Consultation", description: "The process begins with an initial consultation with a civil trial attorney. You'll meet with your attorney who will go through the details of your case with you. They'll ask you questions about what happened, any treatment you've already received, and other important facts and circumstances. They'll make sure you fully understand the process and what to expect from start to finish."},
