...
const Process = () => {
    ...
    const timeline = [
        {id: 0, point: "Legal Consultation", description: "The process begins when you go in for your free consultation. You'll meet with a an attorney who will go through the details of your case with you. They'll ask you questions about what happened, any treatment you've already received, and other important contexts. They'll make sure you fully understand the process and what to expect."},
        {id: 1, point: "Investigation", description: "After you retain us, we will get to work right away. Your team includes both an attorney and a paralegal. Together they work to investigate your case, including reports, records, witness statements and more."},
        {id: 2, point: "Strategize", description: "Every case is unique, which means each strategy is also unique and highly customized. Sometimes we may file a lawsuit right away, other times we may wait until the right time. In each situation, our team uses cutting-edge technology, advanced resources, and extensive experience to plan each and every step of a client’s case strategy."},
