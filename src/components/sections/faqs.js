...
const Faqs = () => {
    ...
    const faqs = [
        {id: 0, point: "How long do I have to file a civil lawsuit?", description: "Each type of claim has a specific 'statute of limitations' or deadline to file a civil lawsuit. Typically, this deadline is between 2 and 3 years from the date of the injury, though certain facts may extend that deadline. It is important that you meet this deadline because, if you fail to do so, your claim could be 'barred'. If you have any questions about Colorado's statute of limitations for your specific case, please give us a call. We are always happy to discuss any questions, issues, or concerns you may have regarding your claim and the claim process."},


        {id: 1, point: "Do I need a civil litigation attorney?", description: "It’s seldom a good idea to handle your case on your own. If you do, the other party’s lawyer or insurance company are much more likely to take advantage of you and not give you anywhere near the amount of money that you deserve. If you suffered any kind of injury or wrong, your own civil trial lawyer can be invaluable in seeking the compensation you deserve. Your lawyer will be experienced with similar cases and will be able to build up your case in a way that maximizes your claim and recovery."},
