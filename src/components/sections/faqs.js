...
const Faqs = () => {
    ...
    const fees = [
        {id:0, name: "Contingency", description: "In some cases, both we and our clients benefit from contingent fee agreements. Details can vary, but essentially, in this arrangement the client pays the law firm an attorney fee only if the firm recovers a settlement or judgment for the client. The fee is usually a percentage of the recovery. If we lose the case, the client does not pay us a fee and is usually responsible only for litigation costs, such as copying costs or expert fees. Under this type of arrangement, we and our clients share both the risk and the reward." },
        ...
        {id:2, name: "Fixed Fee", description: "A fixed fee agreement is one in which the client pays a fixed fee for the legal representation, regardless of the time required. Fixed fees are often used in criminal defense representations, as well as many different types of litigation, such as a simple breach of contract case or foreclosure proceeding. The client often is required to pay litigation costs in addition to the fixed fee." },
