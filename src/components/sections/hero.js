            ...
            <div className="relative isolate bg-hero bg-cover bg-no-repeat h-[500px] xl:h-screen">
                <div className="h-full w-full bg-neutral-50/70 flex align-center">
                    <div className="flex flex-col justify-center mx-auto max-w-5xl gap-6 p-4">
                        ...
                        <p className="font-['Source_Sans_Pro'] text-2xl md:text-3xl lg:text-4xl italic">{siteMetaData.tagline}</p>
                        
                        <div className="flex flex-col sm:flex-row gap-4">
                            
                            <Link to="/client-intake-form" className="bg-primary hover:shadow-lg text-white text-md md:text-lg font-bold p-4 rounded-lg text-center">Schedule Your Free Consultation</Link>
