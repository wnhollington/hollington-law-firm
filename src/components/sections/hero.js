...
const Hero = () => {
    ...
    return (
        <section>
            <div className="relative isolate bg-landing-construction-defect bg-cover bg-no-repeat h-[500px] xl:h-screen">
                <div className="h-full w-full bg-stone-50/80 flex align-center">
