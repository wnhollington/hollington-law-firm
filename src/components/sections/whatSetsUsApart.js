...
const WhatSetsUsApart = () => {
    const process = [
        ...
        {id: 5, heading: "5. We'll get you the best result possible", caption: "Our team has a track record of getting clients great outcomes. We will pursue full and complete justice on your behalf, regardless of any obstacles along the way."},
    ]
                            ...
                            <Slider>                            
                                {
                                    process.map((step, index) => {
                                        return (
                                            <Slide index={1}>
                                                <div className="items-center justify-center block m-4 p-6 shadow-lg h-auto">
                                                    <div className="w-28">{svgIcons(index)}</div>
