  ...
  return (
    <Layout>
      <div className="flex flex-col items-center m-4 p-4">
        ...
        <p className="text-xl font-medium text-gray-900 max-w-5xl">Thank you very much for giving Hollington Law Firm the opportunity to evaluate your legal matter. This form is part of a process that will allow us to determine whether our firm is the right fit for your matter and to run a conflict check. Once you complete this form, you will be directed to our scheduling page to schedule your initial consultation.</p>
